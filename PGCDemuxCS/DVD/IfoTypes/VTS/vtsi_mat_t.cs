...
namespace PgcDemuxCS.DVD.IfoTypes.VTS
{
    ...
    /// </summary>
    internal class vtsi_mat_t
    {
        /// <summary>
        /// 12 bytes
        /// </summary>
        internal string vts_identifier;
        internal uint vts_last_sector;
        internal byte[] zero_1 = new byte[12];
        internal uint vtsi_last_sector;
        internal byte zero_2;
        internal byte specification_version;
        internal uint vts_category;
        internal ushort zero_3;
        internal ushort zero_4;
        internal byte zero_5;
        internal byte[] zero_6 = new byte[19];
        internal ushort zero_7;
        internal byte[] zero_8 = new byte[32];
        internal ulong zero_9;
        internal byte[] zero_10 = new byte[24];
        internal uint vtsi_last_byte;
        internal uint zero_11;
        internal byte[] zero_12 = new byte[56];

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vtsm_vobs;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vtstt_vobs;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vts_ptt_srpt;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vts_pgcit;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vtsm_pgci_ut;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vts_tmapt;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vtsm_c_adt;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vtsm_vobu_admap;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vts_c_adt;

        /// <summary>
        /// Sector
        /// </summary>
        internal uint vts_vobu_admap;
        internal byte[] zero_13 = new byte[24];

        internal video_attr_t vtsm_video_attr;
        internal byte zero_14;
        ...
        internal byte nr_of_vts_audio_streams;
        internal audio_attr_t[] vts_audio_attr;
        internal byte[] zero_20 = new byte[17];
        internal byte nr_of_vts_subp_streams;
        internal subp_attr_t[] vts_subp_attr;
        internal ushort zero_21;
        internal multichannel_ext_t[] vts_mu_audio_attr = new multichannel_ext_t[8];
