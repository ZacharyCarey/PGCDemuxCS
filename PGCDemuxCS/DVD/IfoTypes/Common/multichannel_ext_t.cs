...
namespace PgcDemuxCS.DVD.IfoTypes.Common
{
    ...
    /// </summary>
    internal class multichannel_ext_t : IStreamReadable<multichannel_ext_t>
    {
        internal byte zero1; // 7 bits
        internal bool ach0_gme; // 1 bit

        internal byte zero2; // 7 bits
        internal bool ach1_gme; // 1 bit

        internal byte zero3; // 4 bits
        internal bool ach2_gv1e; // 1 bit
        internal bool ach2_gv2e; // 1 bit
        internal bool ach2_gm1e; // 1 bit
        internal bool ach2_gm2e; // 1 bit

        internal byte zero4; // 4 bits
        internal bool ach3_gv1e; // 1 bit
        internal bool ach3_gv2e; // 1 bit
        internal bool ach3_gmAe; // 1 bit
        internal bool ach3_se2e; // 1 bit

        internal byte zero5; // 4 bits
        internal bool ach4_gv1e; // 1 bit
        internal bool ach4_gv2e; // 1 bit
        internal bool ach4_gmBe; // 1 bit
        internal bool ach4_seBe; // 1 bit

        internal byte[] zero6 = new byte[19];
        ...
        public static multichannel_ext_t? Read(Stream file)
        {
            try
            {
