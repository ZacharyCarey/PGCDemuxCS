...
namespace PgcDemuxCS.DVD.IfoTypes.VMGI
{
    ...
    /// </summary>
    public class title_info_t : IStreamReadable<title_info_t>
    {
        internal const uint Size = 12;

        public playback_type_t pb_ty; // TODO rename "title type"
        public byte nr_of_angles;
        public ushort nr_of_ptts;
        public ushort parental_id;
        public byte title_set_nr;
        public byte vts_ttn;
        public uint title_set_sector;
