...
namespace PgcDemuxCS.DVD.IfoTypes.VMGI 
{
    ...
    /// </summary>
    public class vmgi_mat_t
    {
        public string vmg_identifier; // 12 bytes
        public uint vmg_last_sector;
        public byte[] zero_1 = new byte[12];
        public uint vmgi_last_sector;
        public byte zero_2;
        public byte specification_version;
        public uint vmg_category;
        public ushort vmg_nr_of_volumes;
        public ushort vmg_this_volume_nr;
        public byte disc_side;
        public byte[] zero_3 = new byte[19];

        /// <summary>
        /// Number of VTSs.
        /// </summary>
        public ushort vmg_nr_of_title_sets;

        /// <summary>
        /// 32 bytes
        /// </summary>
        public string provider_identifier; 
        public ulong vmg_pos_code;
        public byte[] zero_4 = new byte[24];
        public uint vmgi_last_byte;
        public uint first_play_pgc;
        public byte[] zero_5 = new byte[56];

        /// <summary>
        /// sector
        /// </summary>
        public uint vmgm_vobs;
        ...
        /// sector
        /// </summary>
        public uint vmgm_pgci_ut;

        /// <summary>
        /// sector
        /// </summary>
        public uint ptl_mait;

        /// <summary>
        /// sector
        /// </summary>
        public uint vts_atrt;

        /// <summary>
        /// sector
        /// </summary>
        public uint txtdt_mgi;

        /// <summary>
        /// sector
        /// </summary>
        public uint vmgm_c_adt;

        /// <summary>
        /// sector
        /// </summary>
        public uint vmgm_vobu_admap;
        public byte[] zero_6 = new byte[32];

        public video_attr_t vmgm_video_attr;
        public byte zero_7;
        public byte nr_of_vmgm_audio_streams; /* should be 0 or 1 */
        public audio_attr_t vmgm_audio_attr;
        public audio_attr_t[] zero_8 = new audio_attr_t[7];
        public byte[] zero_9 = new byte[17];
        public byte nr_of_vmgm_subp_streams; /* should be 0 or 1 */
        public subp_attr_t vmgm_subp_attr;
        public subp_attr_t[] zero_10 = new subp_attr_t[27];  /* XXX: how much 'padding' here? */
        ...
        private vmgi_mat_t(Stream file)
        {
            ...
            provider_identifier = file.ReadString(32);
