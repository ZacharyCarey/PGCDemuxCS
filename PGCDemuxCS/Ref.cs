namespace PgcDemuxCS
{
    ...
    internal class NullRef<T> : Ref<T>
    {
    ...
    internal class ConstRef<T> : Ref<T>
    {
        private T Value;
    ...
    internal class ArrayRef<T> : Ref<T>
    {
        protected T[] Data;
    ...
    internal class ByteArrayRef : ArrayRef<byte>
    {
